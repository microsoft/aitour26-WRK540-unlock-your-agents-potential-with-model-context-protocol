## Mga Modelo na Kailangan para sa Zava DIY

- gpt-4o-mini
- text-embedding-small-3

## Synthentic Data Generation para sa Zava DIY

Ang Zava DIY ay isang tool na idinisenyo upang tumulong sa mga developer na lumikha ng synthetic data para sa testing at development purposes. Nagbibigay-daan ito sa mga user na mag-generate ng realistic datasets na maaaring gamitin sa iba't ibang applications, na tinitiyak na ang data ay nakakatugon sa mga specific na requirement nang hindi nakakasama sa privacy o security.
...
- **8 stores** sa buong Washington State, bawat isa ay may kakaibang inventory at sales data
- **50,000+ customer records** sa buong Washington State at online
- **400+ DIY products** kasama ang mga tools, outdoor equipment, at home improvement supplies
- **400+ product images** na naka-link sa database para sa image-based searches
- **200,000+ order transactions** na may detalyadong sales history
- **3000+ inventory items** sa maraming stores
- **Image embeddings** para sa product images na nagbibigay-daan sa AI-powered similarity searches (encoded gamit ang [openai/clip-vit-base-patch32](https://huggingface.co/openai/clip-vit-base-patch32/blob/main/README.md){:target="_blank"})
- **Text embeddings** para sa product descriptions na nagpapahusay sa search at recommendation capabilities [openai/text-embedding-3-small](https://ai.azure.com/catalog/models/text-embedding-3-small){:target="_blank"}

Sinusuportahan ng database ang mga complex queries at analytics, na nagbibigay-daan sa efficient access sa sales, inventory, at customer data. Ang PostgreSQL Row Level Security (RLS) ay naglilimitang mga agents sa data lamang para sa kanilang assigned stores, na tinitiyak ang security at privacy.

## Zava DIY Product Dataset

Ang Zava DIY PostgreSQL database ay nagbibigay ng comprehensive retail ecosystem na may realistic data patterns:

| Component             | Count    | Description                                                  |
| --------------------- | -------- | ------------------------------------------------------------ |
| **Customers**         | 50,000+  | Realistic demographic profiles sa buong Washington State    |
| **Products**          | 400+     | Kumpletong DIY home improvement catalog                      |
| **Stores**            | 8        | Physical + online locations sa buong Washington State       |
| **Order Items**       | 200,000+ | Detalyadong line items na may pricing at quantities         |
...
Kasama sa dataset ang mga sumusunod na product categories na may lahat ng available products:
...
Kasama sa dataset ang realistic seasonal variations:

- **Spring Surge**: Tumutuaas ang paint at garden products sa March-May
- **Summer Construction**: Tumutuaas ang power tools at lumber sa June-August
- **Fall Preparation**: Tumataas ang hardware at storage products
- **Winter Maintenance**: Hand tools at indoor projects

### 💰 Financial Modeling

- **Consistent 33% gross margin** sa lahat ng products
- **Year-over-year growth patterns** (2020-2026)
- **Store performance variations** batay sa market size
- **Seasonal revenue fluctuations** na naaayon sa product demand
